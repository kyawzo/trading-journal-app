            ...
            {activeAction.locked ? (
              ...
              <form method="POST" action={`/api/positions/${positionId}/actions/${activeAction.id}`} className="flex min-h-0 flex-1 flex-col">
                ...
                <div className="form-grid">
                  ...
                  <label className="field-stack"><span className="field-label">Currency</span><select name="currency" defaultValue={activeAction.currency} className="select-field"><option value="USD">USD</option><option value="SGD">SGD</option></select></label>
